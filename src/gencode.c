...
void do_extend(ap,isize,osize,flags)
/*
...
{       struct amode    *ap1, *ap2;
        ...
        node = node->v.p[1];
        ap1 = gen_expr(node->v.p[0],flags,0); /* TODO: bug fix? */
        freeop(ap1);
